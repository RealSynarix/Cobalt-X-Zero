...
void clock_init(void) {
  ...
  r.Prescaler = RCC_CRS_SYNC_DIV1;
  r.Source = RCC_CRS_SYNC_SOURCE_USB;
  r.ReloadValue = __HAL_RCC_CRS_RELOADVALUE_CALCULATE(48000000, 1000);
  r.ErrorLimitValue = 34;
  r.HSI48CalibrationValue = 32;
  HAL_RCCEx_CRSConfig(&r);
